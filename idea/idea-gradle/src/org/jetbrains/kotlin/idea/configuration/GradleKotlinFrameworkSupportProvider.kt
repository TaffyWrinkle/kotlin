...
open class GradleKotlinJSBrowserFrameworkSupportProvider(
    ...
    override fun getDescription() =
        KotlinIdeaGradleBundle.message("description.text.a.single.platform.kotlin.library.or.application.targeting.javascript.for.browser")
...
open class GradleKotlinJSNodeFrameworkSupportProvider(
    ...
    override fun getDescription() =
        KotlinIdeaGradleBundle.message("description.text.a.single.platform.kotlin.library.or.application.targeting.javascript.for.node.js")
}
