...
class KotlinGradleSharedMultiplatformModuleBuilder : KotlinGradleAbstractMultiplatformModuleBuilder() {
    ...
    override fun getDescription() =
        KotlinIdeaGradleBundle.message("description.multiplatform.gradle.project.allowing.reuse.of.the.same.kotlin.code.between.all.three.main.platforms.jvm.js.and.native")
